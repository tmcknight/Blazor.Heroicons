...
<Heroicon Name="@HeroiconName.Sparkles" Style="HeroiconStyle.Outline" class="h-6 w-6 text-yellow-600" />
```
...
<RandomHeroicon Style="HeroiconStyle.Mini" class="h-6 w-6 text-green-700" />
```
